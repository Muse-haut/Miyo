WELCOME_GIFS = [
  ...
  "[On va danser toute la night !](https://tenor.com/bIp7j.gif)",
  "[*Slurp*](https://tenor.com/bH0C4.gif)",
  "[Kaboom](https://tenor.com/rwu4oMnem61.gif)",
  "[J'étais comme ça en t'attendant](https://tenor.com/bKo3m.gif)",
  "[J'chui trop content que tu sois là !](https://tenor.com/iwfEom9zOq7.gif)",
  "[J'crois j'ai oublié de dire quelque chose...](https://tenor.com/tW5WMtygw7q.gif)",
  "[Tema le banger que c'est, jeune](https://tenor.com/h7KKa5isBVl.gif)",
  "[Choose your path !](https://tenor.com/kiuHV36VW15.gif)",
  "[YAY !](https://tenor.com/unHxw8pKAij.gif)",
  "[Mambo.](https://tenor.com/frfO5WBMxmo.gif)",
  "[TU SLAY TROP QUEEEEEN](https://tenor.com/bhDyj.gif)",
  "[Que ce passeras t-il après ? Personne ne le sais, t'es maître de tes décisions](https://tenor.com/pTC3Pn2Gike.gif)",
  "[T'as un 06 ?](https://tenor.com/fQ1di4DFsFG.gif)",
  "[Un futur radieux se peint à l'horizon !](https://tenor.com/p290FVnSg0T.gif)",
  "[Wake the fuck up, Samurai!][https://tenor.com/bZfcT.gif]", 
  "[TROP COOL !](https://tenor.com/bZf3X.gif)",
  "[P'tit checkup avant tout](https://tenor.com/rzsz2XDe7hH.gif)",
  "[Viens passer des bons moments avec nous !](https://tenor.com/fB8PMcqr3OV.gif)",
  "[On arrive pour te souhaiter la bienvenue, bro !](https://tenor.com/GumsU7uBiw.gif)",
  "[POV : Moi avant VS après ton arrivée](https://tenor.com/bAEim.gif)",
...
WELCOME_MESSAGES = [
  ...
  "J'commençais à m'inquiéter, on attendais plus que toi {user} !",
  "EH LES GENS, Y'A UN NOUVEAU MEMBRE IL S'APPELLE {user} ! VENEZ LUI SOUHAITER LA BIENVENUE !",
  "Un {user} est apparu ! Voulez vous l'accueillir ?",
  "Avec Ruby et Sako, on te souhaites la bienvenue {user} !",
  "Trop tuff ton arrivée {user} !",
  "Ton arrivée est aussi goatesque que la Pokobomb, {user} !",
  "Tiens, mais ça serait pas {user} ? Mais si ! C'est bien lui ! Bienvenue parmis nous !",
  "{user} EST ARRIVÉ ! MAIS C'ÉTAIS SÛR EN FAIT, C'ÉTAIS SÛR !",
  "{user} est arrivé à bon port sur {server} !",
  "J'étais quasiment sûr que {user} ferait son apparition avant, mais ce n'est pas trop mal !",
  "Bienvenue, noble {user}, en ces lieux de savoir et d’auguste quiétude ; puisse ta venue y être aussi féconde qu’agréable, et ton esprit y fleurir en exquise allégresse.",
  "YO TOUS LE MONDE C'EST {user} QUI EST APPARU !",
  "En ceste alcôve de savoir, je vous salue, {user} avec déférence et mansuétude. Puisse vostre venue estre propice à maintes délibérations exquises. Soyez le bienvenu, en toute quiétude."
]
...
class WelcomeMessage < CommandLoader
  self.passive = true
  def self.register(bot)
    bot.member_join do |event|
        ...
        if welcome_system['Enabled'] = true
            target_channel = event.server.text_channels.find { |c| c.id == welcome_system['Channel ID'] }
            if target_channel
                sleep 2
